...
TRAINING_DATASET_CONFIG="examples/training/sft/cogvideox/crush_smol_lora/training_wisa.json"
VALIDATION_DATASET_FILE="examples/training/sft/cogvideox/crush_smol_lora/validation_wisa.json"
...
model_cmd=(
  ...
  --pretrained_model_name_or_path "./pretrain_models/CogVideoX-5b-Diffusers"
)
...
exper_name="cogvideox-5b-wisa/exp_name"
# Miscellaneous arguments
miscellaneous_cmd=(
  --tracker_name "finetrainers-wisa-cogvideox"
