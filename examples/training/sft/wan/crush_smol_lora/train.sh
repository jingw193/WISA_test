...
model_cmd=(
  --model_name "wan"
  --pretrained_model_name_or_path "./pretrain_models/wan2.1_14B_diffusers"
)
...
training_cmd=(
  ...
  --resume_from_checkpoint 100
  --enable_slicing
  --enable_tiling
)
# /maao-data-cephfs-3/workspace/wangjing/physical_projects/finetrainers/outputs
# Optimizer arguments
optimizer_cmd=(
  --optimizer "adamw"
  --lr 5e-5
...
miscellaneous_cmd=(
  --tracker_name "finetrainers-wan-lora"
  --output_dir "./outputs/checkpoints/exp1001_wisadata_lora_2"
  --logging_dir "./outputs/logs/exp1001_wisadata_lora_2"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
