...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/crush_smol_lora/training_wisa.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/crush_smol_lora/validation_wisa.json"
ROOT_PATH="outputs"

# Depending on howexamples/training/sft/wan/crush_smol_lora/train_wisa.sh many GPUs you have available, choose your degree of parallelism and technique!
...
model_cmd=(
  --model_name "wan"
  --pretrained_model_name_or_path "./pretrain_models/wan2.1_14B_diffusers_notebook"
)
...
dataset_cmd=(
  --dataset_config $TRAINING_DATASET_CONFIG
  --dataset_shuffle_buffer_size 10
  --precomputation_items 2000
  # --enable_precomputation
  --precomputation_once
  --precomputation_dir ./${ROOT_PATH}/cache/path
  --hash_save
)
...
exper_name="wanx2_1_14B_wisa/exp_name"
# Miscellaneous arguments
miscellaneous_cmd=(
  --tracker_name "finetrainers-wan-wisa"
  --output_dir ./${ROOT_PATH}/checkpoints/${exper_name}
  --logging_dir ./${ROOT_PATH}/logs/${exper_name}
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
